...
- assignee_hint: extract WHO the task is for when the speaker names a staff
  or boss first name (e.g. "untuk Bayu", "Sandra tolong…", "ingatkan Ian",
  "untuk Prista", "assign this to Admin"). Return only the spoken first name.
  If nobody is named or it is unclear, return null — do not guess.`;
